...
# source: sawtooth_settings/protobuf/transaction.proto
...
TransactionHeader = _reflection.GeneratedProtocolMessageType('TransactionHeader', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_settings.protobuf.transaction_pb2'
