...
# source: sawtooth_settings/protobuf/validator.proto
...
MessageList = _reflection.GeneratedProtocolMessageType('MessageList', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_settings.protobuf.validator_pb2'
