...
# source: sawtooth_settings/protobuf/authorization.proto
...
ConnectionRequest = _reflection.GeneratedProtocolMessageType('ConnectionRequest', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_settings.protobuf.authorization_pb2'
