...
# source: sawtooth_identity/protobuf/transaction.proto
...
TransactionHeader = _reflection.GeneratedProtocolMessageType('TransactionHeader', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_identity.protobuf.transaction_pb2'
