...
# source: sawtooth_identity/protobuf/client_list_control.proto
...
ClientPagingControls = _reflection.GeneratedProtocolMessageType('ClientPagingControls', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_identity.protobuf.client_list_control_pb2'
