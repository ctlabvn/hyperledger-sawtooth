...
# source: sawtooth_identity/protobuf/validator.proto
...
MessageList = _reflection.GeneratedProtocolMessageType('MessageList', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_identity.protobuf.validator_pb2'
