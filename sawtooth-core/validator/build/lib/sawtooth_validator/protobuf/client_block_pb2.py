...
# source: sawtooth_validator/protobuf/client_block.proto
...
from sawtooth_validator.protobuf import block_pb2 as sawtooth__validator_dot_protobuf_dot_block__pb2
...
_CLIENTBLOCKLISTREQUEST.fields_by_name['paging'].message_type = sawtooth__validator_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGCONTROLS
_CLIENTBLOCKLISTREQUEST.fields_by_name['sorting'].message_type = sawtooth__validator_dot_protobuf_dot_client__list__control__pb2._CLIENTSORTCONTROLS
_CLIENTBLOCKLISTRESPONSE.fields_by_name['status'].enum_type = _CLIENTBLOCKLISTRESPONSE_STATUS
_CLIENTBLOCKLISTRESPONSE.fields_by_name['blocks'].message_type = sawtooth__validator_dot_protobuf_dot_block__pb2._BLOCK
_CLIENTBLOCKLISTRESPONSE.fields_by_name['paging'].message_type = sawtooth__validator_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGRESPONSE
...
_CLIENTBLOCKGETRESPONSE.fields_by_name['block'].message_type = sawtooth__validator_dot_protobuf_dot_block__pb2._BLOCK
...
ClientBlockListRequest = _reflection.GeneratedProtocolMessageType('ClientBlockListRequest', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_validator.protobuf.client_block_pb2'
