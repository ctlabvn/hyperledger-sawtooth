...
# source: sawtooth_validator/protobuf/validator.proto
...
MessageList = _reflection.GeneratedProtocolMessageType('MessageList', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_validator.protobuf.validator_pb2'
