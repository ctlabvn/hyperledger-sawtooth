...
# source: sawtooth_cli/protobuf/validator.proto
...
MessageList = _reflection.GeneratedProtocolMessageType('MessageList', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_cli.protobuf.validator_pb2'
