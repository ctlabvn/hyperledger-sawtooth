...
# source: sawtooth_cli/protobuf/client_state.proto
...
_CLIENTSTATELISTREQUEST.fields_by_name['paging'].message_type = sawtooth__cli_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGCONTROLS
_CLIENTSTATELISTREQUEST.fields_by_name['sorting'].message_type = sawtooth__cli_dot_protobuf_dot_client__list__control__pb2._CLIENTSORTCONTROLS
...
_CLIENTSTATELISTRESPONSE.fields_by_name['paging'].message_type = sawtooth__cli_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGRESPONSE
...
ClientStateListRequest = _reflection.GeneratedProtocolMessageType('ClientStateListRequest', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_cli.protobuf.client_state_pb2'
