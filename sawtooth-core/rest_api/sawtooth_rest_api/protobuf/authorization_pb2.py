...
# source: sawtooth_rest_api/protobuf/authorization.proto
...
ConnectionRequest = _reflection.GeneratedProtocolMessageType('ConnectionRequest', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_rest_api.protobuf.authorization_pb2'
